        ...
        <el-tabs type='border-card' @tab-click='tabChange'>
            <el-tab-pane>
                ...
                <el-table :data='employeeAdv' style='width: 100%'>
                    ...
                    <el-table-column prop='employee.name' label='员工名'>
                    ...
                    <el-table-column prop='employee.workId' label='员工号'></el-table-column>
                    <el-table-column label='奖惩日期'>
                        <template slot-scope='scope'>
                            {{ scope.row.createDate | dateFormat }}
                        </template>
                    </el-table-column>
                    <el-table-column prop='point' label='奖惩分数'>
                        <template slot-scope='scope'>
                    ...
                    <el-table-column prop='reason' label='奖惩原因'>
                        <template slot-scope='scope'>
            ...
            <el-tab-pane>
                ...
                <el-table :data='employeeTrain' style='width: 100%'>
                    ...
                    <el-table-column prop='trainContent' label='培训内容'></el-table-column>
                </el-table>
            </el-tab-pane>
            <el-tab-pane>
        <span slot='label'><i class='el-icon-shopping-bag-1'></i>考评资料</span>
                <el-table :data='employeeAppraise' style='width: 100%'>
                    ...
                    <el-table-column prop='employee.workId' label='员工号'></el-table-column>
                    <el-table-column label='考评日期'>
                        <template slot-scope='scope'>
                            {{ scope.row.createDate | dateFormat }}
                        </template>
                    </el-table-column>
                    <el-table-column prop='appraiseContent' label='考评内容'>
                    </el-table-column>
                    <el-table-column prop='appraiseResult' label='考评结果'>
                        <template slot-scope='scope'>
            ...
            <el-tab-pane>
                ...
                <el-table :data='employeeMove' style='width: 100%'>
                    ...
                    <el-table-column prop='employee.workId' label='员工号'></el-table-column>
                    <el-table-column label='调动日期'>
                        <template slot-scope='scope'>
                            {{ scope.row.removeDate | dateFormat }}
                        </template>
                    </el-table-column>
                    <el-table-column prop='beforeDepartmentName' label='调前部门'>
                    </el-table-column>
                    <el-table-column prop='beforeJobName' label='调前职位'>
                    </el-table-column>
                    <el-table-column prop='reason' label='调薪原因'>
                    </el-table-column>
                    <el-table-column prop='afterDepartmentName' label='调后部门'>
                    </el-table-column>
                    <el-table-column prop='afterJobName' label='调后职位'>
                    </el-table-column>
            ...
            <el-tab-pane>
                ...
                <el-table :data='empSalaryInfo' stripe>
                    ...
                    <el-table-column prop='workId' label='员工号'></el-table-column>
                    <el-table-column prop='departmentName' label='部门'></el-table-column>
                    <el-table-column prop='jobLevelName' label='职称'></el-table-column>
                    <el-table-column prop='salary.name' label='账套名称'></el-table-column>
                    <el-table-column prop='wagesPayable' label='工资'>
                        <template slot-scope='scope'>
...
<script>
    export default {
        ...
        methods: {
            handleNumChange(val) {
                console.log('handleNumChange'+val)
                this.pageNum = val
